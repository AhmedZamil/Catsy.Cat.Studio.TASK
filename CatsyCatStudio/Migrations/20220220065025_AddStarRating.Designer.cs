...
namespace CatsyCatStudio.Migrations
{
    ...
    [Migration("20220220065025_AddStarRating")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CatsyCatStudio.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("CatsyCatStudio.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("CatsyCatStudio.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("CatsyCatStudio.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CatsyCatStudio.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("CatsyCatStudio.Models.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("CatsyCatStudio.Models.OrderDetail", b =>
                {
                    b.HasOne("CatsyCatStudio.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CatsyCatStudio.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CatsyCatStudio.Models.Pie", b =>
                {
                    b.HasOne("CatsyCatStudio.Models.Category", "Category")
                        .WithMany("Pies")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CatsyCatStudio.Models.StoreUser", null)
                        .WithMany()
